...
public class RcvWarehouseTransferViewHolder extends BaseViewHolder<WarehouseTransferItem,
    ...
    public void onBind(final WarehouseTransferItem item,
        ...
        if (item.getInv_TransferTypeCode() != null)
            txt_tranfertipi.setText(StringUtil.nullToString(item.getInv_TransferTypeCode().getText()));
        ...
        if (item.getInv_RequestDate() != null)
            txt_tarih.setText(StringUtil.nullToString(item.getInv_RequestDate()));
