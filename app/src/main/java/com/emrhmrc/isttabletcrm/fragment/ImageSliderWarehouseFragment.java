...
public class ImageSliderWarehouseFragment extends DialogFragment implements View.OnClickListener {
    ...
    public static ImageSliderWarehouseFragment newInstance(WarehouseItem item, int position) {
        Bundle args = new Bundle();
        args.putInt("position", position);
        args.putString("id", item.getProductNumber());
        if(item.getInv_Productid()!=null)
        args.putString("info", item.getInv_Productid().getText());
        else  args.putString("info", "");
        args.putString("image", item.getImage());
        ImageSliderWarehouseFragment fragment = new ImageSliderWarehouseFragment();
